...
import md051 from "./rules/md051.js";
import md052 from "./rules/md052.js";
import md053 from "./rules/md053.js";
import md054 from "./rules/md054.js";
import md055 from "./rules/md055.js";
import md056 from "./rules/md056.js";
import md058 from "./rules/md058.js";
import md059 from "./rules/md059.js";
import md060 from "./rules/md060.js";
...
const configs = {
  recommended: {
    ...
    rules: {
      ...
      [`markdownlint/${Rule.MD051}`]: 2,
      [`markdownlint/${Rule.MD052}`]: 2,
      [`markdownlint/${Rule.MD053}`]: 2,
      [`markdownlint/${Rule.MD054}`]: 2,
      [`markdownlint/${Rule.MD055}`]: 2,
      [`markdownlint/${Rule.MD056}`]: 2,
      [`markdownlint/${Rule.MD058}`]: 2,
      [`markdownlint/${Rule.MD059}`]: 2,
      [`markdownlint/${Rule.MD060}`]: 2,
    },
  },
};
