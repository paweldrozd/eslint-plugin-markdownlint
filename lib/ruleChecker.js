...
const getRange = (src, err) => {
  ...
  const text = src.getText().split(os.EOL);
...
// eslint-disable-next-line eslint-plugin/prefer-object-rule, eslint-plugin/require-meta-type, eslint-plugin/require-meta-schema
